...
use App\Http\Controllers\ShipmentNotesController;
    ...
    Route::post('/request-access-ip', [HomeipController::class, 'request']);
        ...
        Route::group(['middleware' => 'prevent-back-history'],function(){
            ...
            Route::group(['prefix' => 'admin', 'middleware' => ['auth']], function(){
                    ...
                    Route::match(['get','post'],'/shipment/activate/req/list',[ShipmentController::class, 'reqlist']);
                    Route::match(['get','post'],'/shipment/activate/req/status',[ShipmentController::class, 'changeshipmentreqStatus']);
                    Route::match(['get','post'],'/shipment/req/list',[ShipmentController::class, 'shipreqlist']);
                    // shipment approve data for normal user (agent)
                    Route::get('/shipment-req', [ShipmentController::class, 'shipmentReq']);
                    Route::get('/shipment/shipment-view/{shipmentid}', [ShipmentController::class, 'shipment_view']);
                    ...
                    Route::post('/shipment-bol-update', [ShipmentController::class, 'shipmentbolupdate']);
                    Route::post('/shipment-bol-update-data', [ShipmentController::class, 'shipmentbolupdatedata']);  
                    
                                        
                    Route::match(['get','post'],'/shipment/notes',[ShipmentNotesController::class, 'ShipmentNotes']);   
                    Route::match(['get','post'],'/validate/shipper-rate-prepay',[ShipmentNotesController::class, 'rateprepay']);   
                    Route::match(['get','post'],'/validate/shipper-rate-prepay-carrier',[ShipmentNotesController::class, 'carrierrateprepay']);   
                    //bol add section start here
                    
                    //bol add section end here
                    Route::get('/carrier-rate-pdf/{shipmentid}', [ShipmentController::class, 'carrier_rate_pdf']);
                    //new info
                    Route::match(['get','post'],'/shipment-bol/{shipmentid}',[ShipmentController::class, 'CarrierBOlitem']);
                    Route::match(['get','post'],'/shipment-bol/one/{shipmentid}',[ShipmentController::class, 'CarrierBOlitemOne']);
                    Route::match(['get','post'],'/shipment-bol/item/{shipmentid}',[ShipmentController::class, 'CarrierBOlitemItem']);
                    Route::match(['get','post'],'/shipment-bol/item/edit/{shipmentid}',[ShipmentController::class, 'CarrierBOlitemItemEdit']);
                    ...
                    /* Carrier Request Log start Here*/ 
                    Route::match(['get','post'],'/carrier/request/log',[CarrierController::class, 'srequsetLog']);
                    Route::match(['get','post'],'/carrier/request/log/all',[CarrierController::class, 'srequsetLogall']);
                    
                    /* Carrier Request Log End Here*/ 
                    ...
                    Route::match(['get','post'],'/carrier/request/resend/{carrier_id}',[CarrierController::class, 'RequsetResend']);
                    Route::match(['get','post'],'/carrier/list',[CarrierController::class, 'carrierlist']);
                    Route::match(['get','post'],'/carrier/disputed',[CarrierController::class, 'disputedcarrier']);
                    Route::match(['get','post'],'/carrier/disputed/status',[CarrierController::class, 'disputedcarrierstatus']);
                    ...
                    Route::match(['get','post'],'/shipper/request/log',[CompanyController::class, 'srequsetLog']);
                    Route::match(['get','post'],'/shipper/request/log/all',[CompanyController::class, 'srequsetLogall']);

                    Route::get('/shipper/request/limit', [CompanyController::class, 'shipper_request_limit']);
                    ...
                    //Load post multipal delete 
                    Route::match(['get','post'],'/load/loadpost-multipal-delete',[LoadController::class, 'loadmuldel']);
                    ...
                    Route::match(['get','post'],'/clear', function(){
                        ...
                        // return redirect(url('http://localhost/amb/admin/'))->with('success', 'Clear Success Fully Cache, Config, Route, View');
