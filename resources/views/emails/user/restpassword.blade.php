                           ...
                           <table cellspacing="0" cellpadding="0" width="100%">
                               <tr>
                                  <td height="50" style="padding:40px;background-color: #fff;">
                                      <h4 style="font-size: 25px; color: #0273bf;">Dear {{ $name }}</h4>

                                        <p>Click here to start new TMS Login.</p>
                                        <!-- <p>Use url: <a href="">{{url('/')}}</p> -->
                                        <a style="display: inline-block; margin: 10px 0px; width: fit-content; padding: 10px 30px; background-color: #c1292e; color: #fff; border-radius: 50px; text-decoration: none; font-size: 13px;" href="{{url('/')}}" target="_blank">Login Now</a>
                                        <p>User name: {{$to}}</p>
                                        <p>Password: {{$password}}</p>

                                        <!--a style="display: inline-block; margin: 30px 0px 0px; width: fit-content; padding: 10px 30px; background-color: #c1292e; color: #fff; border-radius: 50px; text-decoration: none; font-size: 13px;" href="#" target="_blank">Verify Email Address</a -->
