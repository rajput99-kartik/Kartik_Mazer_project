                                    ...
                                    <div class="req_comment">
                                        ...
                                        <form action="{{url('/admin/carrier/StatusUpdate')}}" method="post">
                                          ...
                                          <div class="col-12 pt-4">
                                              ...
                                              <button onclick="return confirm('Are You Sure You Want to DisApprove This Carrier..!')" name="disapprove" class="btn btn-danger  px-4 request_update" value="2" type="submit">DisApprove</button>
                                          </div>
                                        </form>
                                    </div>
                                </div>
