		...
		<div class="page-wrapper">
			<div class="page-content">
                ...
                <ul class="nav nav-tabs">
                    ...
                    @endcan
                    <li class="pending_approval active"><a href="{{url('/admin/shipment/req/list')}}" data-toggle="tab" aria-expanded="true">All Req Shipments</a></li>
                </ul>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="copy-text">{{ isset($companies_res->id) ? $companies_res->id : Null }}</td>
                                                            ...
                                                            @php
                                                              //  dd($companies_res);
                                                            @endphp
                                                        <td class="copy-text">{{ isset($companies_res->b_customer_name) ? $companies_res->b_customer_name : Null }}</td>
                                                        <td class="copy-text">{{ $companies_res->customer_c_name }}</td>
...
<script>
    $(function() {
        $(document).on('change','.stat_check', function() {
            ...
            $.ajax({
                type:"post",
                url:"{{ url('admin/shipment/activate/req/status') }}",
