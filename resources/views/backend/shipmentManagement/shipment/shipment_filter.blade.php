                          ...
                          //dd($pick_date);
                                            ...
                                            <td class="action_tooltip">
                                                <a href="{{ url('admin/shipment/shipment-edit',$companies_res->id )}}"> 
                                                ...
                                                <a href="{{ url('admin/shipment/shipment-edit',$companies_res->id )}}" class="btn btn-outline-secondary btn-sm radius-30 px-4"> <i class="bx bx-edit"></i> <span class="tooltip">Edit</span></a>  
