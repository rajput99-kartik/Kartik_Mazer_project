            ...
            <div class="col-xl-12 mx-auto">
                <div class="card  border-primary shipper_caont">
                    ...
                    <div class="card-body p-3 ">
						<div class="row g-3">
							<form action="{{url('admin/shipment-update')}}" id="shipmentupdate" method="POST" enctype="multipart/form-data" class="placeholder-form">  
								@csrf
								<div class="row">
                                    <div class="col-md-6">
                                        <div class="shipment-more-details card card-primary">
                                            ...
                                            <div class="row card-body">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group shipment-more">
                                                        <input type="text" class="form-control form-control-sm mb-3" name="footage_loads" placeholder="Footage" value="{{ $shipmentData->footage_loads }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group shipment-more">
                                                        ...
                                                        <table class="table addCusRate">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td style="width:12%"><input type="text" name="unit2_customer" value="" class="form-control form-control-sm mb-3"></td>
                                ...
                                <a href="<?php echo url('/admin/carrier-bol').'/'.($shipmentData->id); ?>" target="_blank" class="btn btn-success">Carrier BOL</a>
							</form>
