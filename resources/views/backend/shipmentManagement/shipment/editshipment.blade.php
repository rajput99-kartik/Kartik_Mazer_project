...
<style>
    ...
    /*    div#PickDropSection .modal-dialog {*/
    /*        width: 46%;*/
    /*        overflow: auto;*/
    /*    }*/
    /*    div#PickDropSection form input, div#PickDropSection form select {*/
    /*        font-size: 12px;*/
    /*    }*/
    /*}*/
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <ul class="nav nav-tabs">
            ...
            <!--<li class="pending_approval"><button id="btnPickDropFrom" class="btn btn-primary" data-toggle="tab" aria-expanded="false" value="{{ $shipmentData->id }}">Pick & Drop</button></li>-->
        </ul>
            ...
            <div class="col-xl-12 mx-auto">
                <div class="card  border-primary shipper_caont">
                    ...
                    @php
                            ...
                            // dd($shipmentData);
                            // dd($shipmentData->companies_id);
                            $companie = App\Models\Company::where('id', $shipmentData->companies_id)->skip(0)->take(1)->offset(0)->first();
                            //   dd($companie);
                    ...
                    @if($companie)
                        <div class="shipment-status limit">
                            ...
                            <div class="shipper-limit-use">
                                ...
                                @endphp
                                <p>Total Used limit: <span> {{ $sum_Price }} </span></p>
                            </div> 
                        </div>
                    @endif

                    <div class="shipment-status pick_drop">
                    <button id="btnPickDropFrom" class="btn btn-primary" data-toggle="tab" aria-expanded="false" value="{{ $shipmentData->id }}">Pick (2) & Drop (1)</button>
                    </div>
                  
                   
                    <div class="exampleScrollableModal" style="margin-left: 90%; margin-top: -50px;">
                        <button type="button" class="btn btn-warning" onclick="success_noti()" data-bs-toggle="modal" data-bs-target="#exampleScrollableModal">Notes </button>
                     </div>
                                ...
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Shipment Notes</h5>
                                        ...
                                        <div class="modal-body" >
                                                ...
                                                @php
                                                   $shipmentnoteData =  App\Models\ShipmentNotes::where('shipment_id', $shipmentData->id)->orderBy('id', 'DESC')->get();
                                                @endphp
                                                <p>
                                                    <div class="expandables-container"> 
                                                        @foreach ($shipmentnoteData as $item)
                                                                @php
                                                                    $uname =  App\Models\User::where('id', $item->user_id)->first();
                                                                @endphp
                                                               
                                                                <div  class="expandable">
                                                                    <p><strong>Name :</strong>{{ $uname->name}}</p>
                                                                    <p><strong>Title :</strong>{{ substr($item->type ,0,7)}}</p>
                                                                    <p class="sectionxznew3">Description: {{substr($item->description ,0,17)}}<span class="expandee" style="">{{substr($item->description ,17)}}</span></p> 
                    ...
                    <div class="card-body p-3 ">
						<div class="row g-3">
							<form action="{{url('admin/shipment-update')}}" id="sh ipmentupdate" method="POST" enctype="multipart/form-data" class="placeholder-form">  
								...
								<div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-primary">
                                            ...
                                            {{-- http://localhost/amb/admin/shipment-update --}}
                                            @php
                                                $user_id = auth()->user()->id ;
                                                if($user_id == 1){
                                                    $cnameinfo = App\Models\Company::Where('approved',1)->get();
                                                    $cnameinfo = App\Models\Company::get();
                                                    // dd($cnameinfo);
                                                }else{
                                                    $cnameinfo = App\Models\Company::where('user_id', $user_id)->orWhere('approved',1)->orderby('id','desc')->get();
                                                }
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group shipment-more" >
                                                            <select name="shippername" class="form-control" id="shipper_name_testamb">
                                                                ...
                                                                {{-- <option value="{{ $shipmentComp->id}}" @if( $shipmentComp->id == $shipmentComp->id) : selected @endif >
                                                                    
                                                                    {{  $shipmentComp->company_name }} 

                                                                    

                                                                    <span style="color: rgb(241, 10, 145);">Limit: " ${!!  $shipmentComp->credit_limit !!}</span> " 
                                                                
                                                                
                                                                </option>  --}}

                                                                @foreach($cnameinfo as $item)
                                                                    <option value="{{ $item->id}}" @if( $item->id == $shipmentComp->id) :  selected @endif >{{  $item->company_name }}  Limit: {{  $item->credit_limit }} </option>      
                                                                @endforeach 
                                                        ...
                                                        <table class="table addCusRate carier_rate">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2"><input type="text" id="customer_total" name="customer_total" value="<?php if(!empty($shipment_rates->customer_total)){ echo '$'.$shipment_rates->customer_total; } ?>" class="form-control customer_total" readonly="">

                                                                    <input type="hidden" id="customer_total_data" name="customer_total_data" value="<?php if(!empty($shipment_rates->customer_total)){ echo '$'.$shipment_rates->customer_total; } ?>" class="form-control customer_total" readonly=""></td>
                                                                </tr>
                                                            ...
                                                            <div class="card card-primary">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group">
																		...
																		@foreach($shipment_doc as $shipper_documnet)
																		@if($shipper_documnet->type == 'shipper_doc')
																		<div class="shipper_doc_id" value="{{ $shipper_documnet->id}}">
																		<a href="{{ url(BACKEND_COMMON_DOC.'/') }}{{ $shipper_documnet->document_name}}" target="_blank"><img src="{{ url(BACKEND_IMG_PATH.'/') }}/doc.png"></a>
																		
																		<a href="javascript:void(0)" id="Carrier_Doc_Del" ><i class="bx bx-trash"></i></a></div>
																		@endif
																		@endforeach
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="shipper_doc_id" value="{{ $shipper_documnet->id}}">
																		<a href="{{ url(BACKEND_COMMON_DOC.'/') }}{{ $shipper_documnet->document_name}}" target="_blank">
                                                                        <img src="{{ url(BACKEND_IMG_PATH.'/') }}/doc.png">
																		</a>
																		<a href="javascript:void(0)" id="Carrier_Doc_Del" ><i class="bx bx-trash"></i></a></div>
																		@endif
																		@endforeach
                                            ...
                                            <div class="card card-primary">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="lumper_files[]" id="fUpload" multiple="" accept="application/pdf">
                                                        @foreach($shipment_doc as $shipper_documnet)
														@if($shipper_documnet->type == 'lumper')
                                                        <div class="shipper_doc_id" value="{{ $shipper_documnet->id}}">
														<a href="{{ url(BACKEND_COMMON_DOC.'/') }}{{ $shipper_documnet->document_name}}" target="_blank">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Gate Fees</label>
                                                        <input type="file" name="gate_fees[]" id="fUpload1" multiple="multiple" accept="application/pdf">
														@foreach($shipment_doc as $shipper_documnet)
														@if($shipper_documnet->type == 'gate_fees')
														<div class="shipper_doc_id" value="{{ $shipper_documnet->id}}">
                                                        <a href="{{ url(BACKEND_COMMON_DOC.'/') }}{{ $shipper_documnet->document_name}}" target="_blank">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body collapse" id="bol_ins">
                                            ...
                                            <table class="table table-bordered" id="dynamic_field"> 
                                                <?php 
                                                    $shipboldata = App\Models\ShipmentBol::where('shipment_id',$shipment_id)->get();
                                                     //  dd($shipboldata);
                                                    ?>
                                                ...
                                                <tr> 
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="hidden" name="bol_id[]" value="{{ $shibol->id}}">
                                                                <input type="text" class="form-control form-control-sm mb-3" name="ofpieces[]" id="ofpieces" autocomplete="off" placeholder="No Of Pieces" value="{{ $shibol->ofpieces}}">
                                                            
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm mb-3" name="descriptions[]" id="descriptions" placeholder="Descriptions" value="{{ $shibol->descriptions}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm mb-3" name="weight[]" id="weight" placeholder="Weight / LBS" value="{{ $shibol->weight}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm mb-3" name="type[]" id="type" placeholder="Type" value="{{ $shibol->type}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm mb-3" name="nmfc[]" id="nmfc" placeholder="NMFC" value="{{ $shibol->nmfc}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm mb-3" name="hazmat[]" id="hazmat" placeholder="Hazmat" value="{{ $shibol->hazmat}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm mb-3" name="productclass[]" id="productclass" placeholder="Class" value="{{ $shibol->productclass}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm mb-3" name="notes[]" id="notes" placeholder="notes" value="{{ $shibol->notes}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    </td>
								...
								<button class="btn btn-primary" id="ShipmentUpdate">Update Shipment</button>
								<a href="<?php echo url('/admin/carrier-rate-pdf').'/'.($shipmentData->id); ?>" target="_blank" class="btn btn-success">Carrier Rate Con.</a>
                                <a href="<?php echo url('/admin/carrier-bol').'/'.($shipmentData->id); ?>" target="_blank" class="btn btn-success" style="display:none">Carrier BOL</a>
                                
                                <a href="<?php echo url('/admin/shipment-bol').'/'.(base64_encode($shipmentData->id)); ?>" target="_blank" class="btn btn-success">Carrier info</a>
							</form>
