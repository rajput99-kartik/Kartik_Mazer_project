					...
					<div class="card-body">
						...
						<div class="table-responsive">
							<table class="table mb-0" id="carrier_table">
                                ...
                                @foreach($userdata as $shipment_data)
                                    <?php

                                        $shipment_res = App\Models\Shipment::where('user_id',$shipment_data['user_id'])->orderBy('id','desc')->get();
                                      //  dd($shipment_res); 
                                    ?>
                                  @foreach($shipment_res as $key => $companies_res)
                                            <?php 
