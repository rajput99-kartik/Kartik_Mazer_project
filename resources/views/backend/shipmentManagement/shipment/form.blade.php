...
<div class="page-wrapper">
    <div class="page-content">
		...
		<div class="card">
			...
			<div class="card-body">
                <form action="{{ $action }}" method="post" id="{{ $form_id }}" enctype="multipart/form-data" class="placeholder-form">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Address ID" name="address" value="{{ isset($shipper_details['address'])? $shipper_details['address']: old('address') }}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="State" name="state" value="{{ isset($shipper_details['state'])? $shipper_details['state']: old('state') }}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="City" name="city" value="{{ isset($shipper_details['city'])? $shipper_details['city']: old('city') }}">
                            </div>
                        </div>
                        
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Zipcode" name="zipcode" value="{{ isset($shipper_details['zipcode'])? $shipper_details['zipcode']: old('zipcode') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Phone" name="phone" value="{{ isset($shipper_details['phone'])? $shipper_details['phone']: old('phone') }}">
                            </div>
                        </div>
