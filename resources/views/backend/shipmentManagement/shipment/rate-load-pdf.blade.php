    ...
    <div class="header">
		...
		<div class="flex">
			<div class="company" style="float:left;">
				...
				<div>
				    <pre style="color:#000; font-size:14px; font-weight:600;">55 East Long Rd Suite no. 
...
Fax: 32678
		...
		<div class="flex" style="margin-top:30px;">
			    <div class="load">
    			    <table style="width:100%" class="border-none">
    			        ...
    			        <tr>
    			            <td><b>Type:</b></td>
    			            <td>{{ isset($pickdata->full_partial) ? $pickdata->full_partial : null }}</td>
    			        ...
    			        <tr>
    			            <td><b>Weight:</b> </td>
    			            <td>{{ isset($pickdata->weight_loads) ? $pickdata->weight_loads : null }}</td>
		...
		<div class="flex" style="margin-top:30px;">
			    <div class="load">
    			    <table style="width:100%" class="border-none">
    			        ...
    			        <tr>
    			            <td><b>Type:</b> </td>
    			            <td><?php if(!empty($dropdata->full_partial)){ echo $dropdata->full_partial; } ?></td>
    			            <td><b>Receiving Hours:</b> </td>
    			        ...
    			        <tr>
    			            <td><b>Weight:</b> </td>
    			            <td><?php if(!empty($dropdata->weight_loads)){ echo $dropdata->weight_loads.' lbs'; } ?></td>
    			            <td valign="top"><b>Description:</b> </td>
    			            <td style="width:150px;">{{ isset($shipmentData->shipment_carrier_instruction) ? $shipmentData->shipment_carrier_instruction : null }}
                            </td>
    			        </tr>
		...
		<div class="flex" style="margin-top:20px;">
		    <div class="load">
			    <table style="width:100%; background:none; border:none" class="border-none">
			        <tr>
			            <td style="width:70px"><b>Driver Name:</b> </td>
			            <td> {{ isset($shipmentData->shipment_c_driver_n) ? $shipmentData->shipment_c_driver_n : null }}<hr></td>
			            <td style="width:40px"><b>Cell #:</b> </td>
			            <td>{{ isset($shipmentData->shipment_c_driver_p) ? $shipmentData->shipment_c_driver_p : null }}<hr></td>
			            <td style="width:70px"><b>Truck #:</b> </td>
			            <td><hr></td>
			            <td style="width:70px"><b>Trailer #:</b> </td>
			            <td><hr></td>
			        </tr>
			    </table>
			</div>
