                                                                    ...
                                                                    <div class="ra-det-container">
                                                                        ...
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-5 col-sm-4 col-md-4 col-lg-3 col-xl-5"><div style="max-width: 120px;"><hr style="margin: 0 -3px 0 0; width: 53px; float: right; border-top: 1px solid #4E5155;" /></div></div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-7 col-sm-8 col-md-8 col-lg-9 col-xl-7 mb-1"></div>
                                                                        ...
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-7 col-sm-8 col-md-8 col-lg-9 col-xl-7 mb-1"></div>
                                                                                <div class="col-5 col-sm-4 col-md-4 col-lg-3 col-xl-5"><div style="max-width: 120px;"><hr style="margin: 0 -3px 0 0; float: right; width: 53px; border-top: 1px solid #4E5155;" /></div></div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-7 col-sm-8 col-md-8 col-lg-9 col-xl-7 mb-1"></div>
                                                                                <div class="col-5 col-sm-4 col-md-4 col-lg-3 col-xl-5"><div style="max-width: 120px;"><span class="float-right"> {{$total_value}}</span></div></div>
