	...
	<div class="page-wrapper">
		<div class="page-content">
			...
			<ul class="nav nav-tabs">
                <li class="pending_approval active"><a href="javascript:void(0)" data-toggle="tab" aria-expanded="true">Payments Pending</a>
                </li>
                <li class="pending_approval"><a href="{{url('/admin/carrier/urgent/payment')}}" data-toggle="tab" aria-expanded="true">Urgent Payments</a>
                </li>
