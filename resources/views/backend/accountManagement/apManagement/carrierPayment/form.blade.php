                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="payment_action">
                                                    ...
                                                    @csrf
                                                    <input name="_method" type="hidden" value="POST">
                                                    <button onclick="return confirm('You want to Update this payment ..!')" class="btn btn-primary" value="{{ isset($shipment_id ) ? $shipment_id : null  }}" type="submit">Pay Now</button>
