            ...
            <tbody class="apfillterlist">
              ...
              @endphp
                ...
                @foreach($shipdata as $udata)
                              ...
                              <td>
                                {{ isset($udata->shipment_statue) ? $udata->shipment_statue : null }}
                              </td>
                              ...
                              <td>
                              @php
                                 $orgDate = $shipmentdrop->d_ready;  
                                $newDate = date("d-m-Y", strtotime($orgDate));  
                               // $date = "17-01-2023";
                              $drop = new Carbon($newDate);
                              $dddata = date('d-m-Y');
                              $end    = new Carbon($dddata);
                              $diff = $drop->diff($end);
                              //echo '<br>'.$diff->d;
                              @endphp
                              {{ $diff->days }}
