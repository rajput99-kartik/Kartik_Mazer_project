                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="custom-file">
                                                                        <input type="file" name="f_noa[]" class="form-control custom-file-input" id="f_noa" multiple="multiple" accept=".jpeg,.png,.jpg,.gif,.svg,.pdf,.xls,.xlsx,.doc,.docx"  required>
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="f_address" placeholder="f_address" class="form-control" value="{{ isset($carrdata['f_address']) ? $carrdata['f_address']: old('f_address') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="f_city" placeholder="f_city" class="form-control" value="{{ isset($carrdata['f_city']) ? $carrdata['f_city']: old('f_city') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="f_state" placeholder="f_state" class="form-control" value="{{ isset($carrdata['f_state']) ? $carrdata['f_state']: old('f_state') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="f_zip" placeholder="f_zip" class="form-control" value="{{ isset($carrdata['f_zip']) ? $carrdata['f_zip']: old('f_zip') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="f_phone" placeholder="f_phone" class="form-control" value="{{ isset($carrdata['f_phone']) ? $carrdata['f_phone']: old('f_phone') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="f_fax" placeholder="f_fax" class="form-control" value="{{ isset($carrdata['f_fax']) ? $carrdata['f_fax']: old('f_fax') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="f_email" placeholder="f_email" class="form-control" value="{{ isset($carrdata['f_email']) ? $carrdata['f_email']: old('f_email') }}">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="c_address" placeholder="c_address" class="form-control" value="{{ isset($carrdata['c_address']) ? $carrdata['c_address']: old('c_address') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="c_city" placeholder="c_city" class="form-control" value="{{ isset($carrdata['c_city']) ? $carrdata['c_city']: old('c_city') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="c_state" placeholder="c_state" class="form-control" value="{{ isset($carrdata['c_state']) ? $carrdata['c_state']: old('c_state') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="c_zip" placeholder="c_zip" class="form-control" value="{{ isset($carrdata['c_zip']) ? $carrdata['c_zip']: old('c_zip') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="c_phone" placeholder="c_phone" class="form-control" value="{{ isset($carrdata['c_phone']) ? $carrdata['c_phone']: old('c_phone') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="c_fax" placeholder="c_fax" class="form-control" value="{{ isset($carrdata['c_fax']) ? $carrdata['c_fax']: old('c_fax') }}">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="c_email" placeholder="c_email" class="form-control" value="{{ isset($carrdata['c_email']) ? $carrdata['c_email']: old('c_email') }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="bank_name" placeholder="bank_name" class="form-control" value="{{ isset($carrdata['bank_name']) ? $carrdata['bank_name']: old('bank_name') }}">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="account_number" placeholder="account_number" class="form-control" value="{{ isset($carrdata['account_number']) ? $carrdata['account_number']: old('account_number') }}">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="b_account_type" placeholder="b_account_type" class="form-control" value="{{ isset($carrdata['b_account_type']) ? $carrdata['b_account_type']: old('b_account_type') }}">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <strong>Rrouting Number</strong>
    
                                                                <input type="text" name="ach_routing_number" placeholder="ach_routing_number" class="form-control" value="{{ isset($carrdata['ach_routing_number']) ? $carrdata['ach_routing_number']: old('ach_routing_number') }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="w_bank_name" placeholder="w_bank_name" class="form-control" value="{{ isset($carrdata['w_bank_name']) ? $carrdata['w_bank_name']: old('w_bank_name') }}">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="w_account_number" placeholder="w_account_number" class="form-control" value="{{ isset($carrdata['w_account_number']) ? $carrdata['w_account_number']: old('w_account_number') }}">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="wire_b_account_type" placeholder="wire_b_account_type" class="form-control" value="{{ isset($carrdata['wire_b_account_type']) ? $carrdata['wire_b_account_type']: old('wire_b_account_type') }}">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="wire_routing_number" placeholder="wire_routing_number" class="form-control" value="{{ isset($carrdata['wire_routing_number']) ? $carrdata['wire_routing_number']: old('wire_routing_number') }}">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="swift_code" placeholder="swift_code" class="form-control" value="{{ isset($carrdata['swift_code']) ? $carrdata['swift_code']: old('swift_code') }}">
