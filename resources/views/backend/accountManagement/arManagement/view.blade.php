		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Account Receivable</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">AR List</li>
							</ol>
						</nav>
					</div>
				</div>
							...
							<table class="table mb-0" id="carrier_table">
                                ...
                                @foreach($userdata as $udata)
                                        ...
                                        <tr>
											...
											<td>{{ isset($tleader['name']) ? $tleader['name'] : null }}</td>
											@endforeach
											...
											@foreach($udata->arTeamAgent as $agent)
											<td>
                                                <a href="{{ url('admin/ar/shipment-detail',base64_encode($agent->id) )}}"> 
                                                <button type="button" value="{{ $agent->id }}" class="btn btn-outline-info btn-sm radius-30 px-4"><i class="bx bx-show"></i></button></a> 
                                            </td>
											@endforeach                                            
                                        </tr>
                                @endforeach
