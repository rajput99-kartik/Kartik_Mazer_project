		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<ul class="nav nav-tabs">
                    ...
                    <li class="pending_approval"><a href="{{url('admin/assign/ar/add')}}" data-toggle="tab" aria-expanded="true">Add New</a>
                    </li>
                </ul>
							...
							@if(count($userdata) > 0)
                                @foreach($userdata as $udata)
                                        ...
                                        <tr>
											...
											<td>
												@php
												$assigntouser= \App\Models\User::where('id',$udata->ar_user)->first();
												@endphp
