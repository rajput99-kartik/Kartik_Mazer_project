...
@section('content')
		...
		<div class="page-wrapper">
			...
			<ul class="nav nav-tabs">
                <li class=""><a href="{{url('admin/notification/messsage')}}" data-toggle="tab" aria-expanded="false">Carrier Message</a>
                </li>
				<li class="active"><a href="javascript:void(0);" data-toggle="tab" aria-expanded="false">Shipper Message</a>
                </li>
							...
							<table class="table mb-0" id="carrier_table">
                                ...
                                @foreach($message_data as $udata)
                                        ...
                                        <tr status="{{$udata->status}}">
                                            ...
                                            <td>
												@php
													$shipper = App\Models\Company::where('id', $udata->companies_id)->first();
												@endphp
                                                 Shipper Name: {{ isset($shipper->company_name) ? $shipper->company_name : Null }}
